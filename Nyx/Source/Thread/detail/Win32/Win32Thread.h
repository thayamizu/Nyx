...
********************************************************************************/
#ifndef NYX_CORE_INCLUDED_WIN32_THREAD_H_
#define NYX_CORE_INCLUDED_WIN32_THREAD_H_
#include "PCH/PCH.h"
...
{
	/// スレッドクラス
	class win32_thread : private noncopyable
	{
	public:
		...
		*/
		explicit  win32_thread(void * fp,  void* param, uint64_t stackSize=0, uint64_t flag=0);
