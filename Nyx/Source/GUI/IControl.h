...
namespace nyx 
{
	...
	enum WIDGET_EVENT_TYPE {
		...
		WIDGET_EVENT_TYPE_LEFT_BUTTON_DOWN,
		WIDGET_EVENT_TYPE_LEFT_BUTTON_UP,
		WIDGET_EVENT_TYPE_RIGHT_BUTTON_DOWN,
		WIDGET_EVENT_TYPE_RIGHT_BUTTON_UP,
		WIDGET_EVENT_TYPE_MIDDLE_BUTTON_DOWN,
		WIDGET_EVENT_TYPE_MIDDLE_BUTTON_UP,
		WIDGET_EVENT_TYPE_PAINT,
		WIDGET_EVENT_TYPE_RESIZE,
		WIDGET_EVENT_TYPE_WINDOW_MOVE,
