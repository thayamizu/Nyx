...
namespace nyx{
	...
	//----------------------------------------------------------------------------------------
	//
	sprite_batch::sprite_batch(int width,  int height, const color4c& color)
		:pimpl_(std::make_shared<sprite_batch::PImpl>(width, height, color)) {
	}


	//----------------------------------------------------------------------------------------
	//
	sprite_batch::sprite_batch(const std::wstring& fileName)
		:pimpl_(std::make_shared<sprite_batch::PImpl>(fileName)) {
	}
	...
	//----------------------------------------------------------------------------------------
	//
	void sprite_batch::fill(const color4c& color) {
	...
	//----------------------------------------------------------------------------------------
	//
	void sprite_batch::set_color(const color4c& color) {
		NYX_ASSERT(pimpl_ != nullptr);
	...
	//----------------------------------------------------------------------------------------
	//
	color4c sprite_batch::get_color() const {
		NYX_ASSERT(pimpl_ != nullptr);
	...
	//----------------------------------------------------------------------------------------
	//
	void sprite_batch::set_rect(const rect2i& rect) {
		NYX_ASSERT(pimpl_ != nullptr);
	...
	//----------------------------------------------------------------------------------------
	//
	rect2i sprite_batch::get_rect() const {
		NYX_ASSERT(pimpl_ != nullptr);
	...
	//----------------------------------------------------------------------------------------
	//
	void sprite_batch::render(const matrix& matrix) const {
		NYX_ASSERT(pimpl_ != nullptr);
