...
namespace nyx {
	//-------------------------------------------------------------------------------------------------------
	//
	dsound_static_audio_buffer::dsound_static_audio_buffer(
		const audio_buffer_desc& bufferDesc, 
		const dsound_ptr dsound, const std::shared_ptr<sound_reader> reader)
		: dsound_stereo_audio_buffer(), waveReader_(reader), bufferDesc_(bufferDesc){
	...
	//-------------------------------------------------------------------------------------------------------
	//
	AudioUtility::AUDIO_BUFFER_TYPE dsound_static_audio_buffer::get_buffer_type() const {
		return AudioUtility::AUDIO_BUFFER_TYPE_STATIC;
	}


	//-------------------------------------------------------------------------------------------------------
	//
	void dsound_static_audio_buffer::write_wave_data(){
		//バッファに波形データの書き込み
	...
	//-------------------------------------------------------------------------------------------------------
	//
	void dsound_static_audio_buffer::build_dsound_buffer_desc(DSBUFFERDESC* dsBufferDesc, WAVEFORMATEX& wfx){
