...
namespace nyx {
	...
	///静的バッファ
	class dsound_static_audio_buffer : public dsound_stereo_audio_buffer {
	public:
		/**
		* コンストラクタ
		...
		*/
		dsound_static_audio_buffer(const audio_buffer_desc& bufferDesc, const dsound_ptr dsound, const std::shared_ptr<sound_reader> fileName);
